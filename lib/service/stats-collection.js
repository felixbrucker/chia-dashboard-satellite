...
class StatsCollection {
  ...
  async updateFarmerStats() {
    ...
    const farmerStats = this.stats.has(service) ? this.stats.get(service) : {};
    farmerStats.signagePoints = await this.farmerApiClient.getSignagePoints();
    this.stats.set(service, farmerStats);
  }
